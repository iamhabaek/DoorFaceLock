...
class Admin:
            ...
            try:
                ...
                if result != None:
                    ...
                    for record in records:
                        if count % 2 ==0:
                            self.treeview.insert(parent='',index='end', iid=count,text='',values=(record[0],record[1],record[2],record[3],record[4],record[5],record[6],record[8]),tags=('evenrow',))
                    
                        else:
                            self.treeview.insert(parent='',index='end', iid=count,text='',values=(record[0],record[1],record[2],record[3],record[4],record[5],record[6],record[8]),tags=('oddrow',))
                        count+=1
                    conn.commit()
                    conn.close()
    ...
    def update_admin(self):
            try:
                    ...
                    cursor = conn.cursor()
                    sql_update = '''update admin set admin_id=%s, firstname=%s ,lastname=%s,address=%s,age=%s,position=%s,username=%s where admin_id=%s '''
                    ...
                    inputs = (admin_id,fn,ln,address,age,pos,username)
    ...
    def search_user(self):
        ...
        for record in rows:
            if count % 2 ==0:
                self.treeview.insert(parent='',index='end', iid=count,text='',values=(record[0],record[1],record[2],record[3],record[4],record[5],record[6],record[7]),tags=('evenrow',))
                    
            else:
                self.treeview.insert(parent='',index='end', iid=count,text='',values=(record[0],record[1],record[2],record[3],record[4],record[5],record[6],record[7]),tags=('oddrow',))
            count+=1
